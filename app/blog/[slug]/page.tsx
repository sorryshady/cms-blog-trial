  ...
  return (
    <div className="mt-8">
      <h1>
        ...
        <span className="mt-2 block text-center text-3xl leading-8 font-bold tracking-tight sm:text-4xl">
          {data.title}
        </span>
      </h1>
      <Image
        ...
        height={800}
        priority
        className="rounded-lg mt-8 border h-[500px] object-cover w-full"
      />
